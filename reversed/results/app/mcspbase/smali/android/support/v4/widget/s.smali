...
.field private j:Landroid/support/v4/widget/u;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/widget/s;->c:Ljava/lang/String;
...
.method static synthetic a(Landroid/support/v4/widget/s;I)Landroid/support/v4/view/a/o;
    .locals 1

    invoke-direct {p0, p1}, Landroid/support/v4/widget/s;->d(I)Landroid/support/v4/view/a/o;
...
.method private a(ILandroid/os/Bundle;)Z
    ...
    invoke-static {v0, p1, p2}, Landroid/support/v4/view/bu;->a(Landroid/view/View;ILandroid/os/Bundle;)Z
...
.method private a(Landroid/graphics/Rect;)Z
    ...
    invoke-static {v0}, Landroid/support/v4/view/bu;->f(Landroid/view/View;)F
...
.method static synthetic a(Landroid/support/v4/widget/s;IILandroid/os/Bundle;)Z
    .locals 1

    invoke-direct {p0, p1, p2, p3}, Landroid/support/v4/widget/s;->b(IILandroid/os/Bundle;)Z
...
.method private b(II)Landroid/view/accessibility/AccessibilityEvent;
    ...
    :pswitch_0
    invoke-direct {p0, p2}, Landroid/support/v4/widget/s;->c(I)Landroid/view/accessibility/AccessibilityEvent;
...
.method private c(I)Landroid/view/accessibility/AccessibilityEvent;
    ...
    invoke-static {v1, v0}, Landroid/support/v4/view/bu;->b(Landroid/view/View;Landroid/view/accessibility/AccessibilityEvent;)V
...
.method private c(II)Landroid/view/accessibility/AccessibilityEvent;
    ...
    sget-object v1, Landroid/support/v4/widget/s;->c:Ljava/lang/String;
    ...
    invoke-static {v0}, Landroid/support/v4/view/a/a;->b(Landroid/view/accessibility/AccessibilityEvent;)Landroid/support/v4/view/a/af;

    move-result-object v1

    iget-object v2, p0, Landroid/support/v4/widget/s;->i:Landroid/view/View;

    invoke-virtual {v1, v2, p1}, Landroid/support/v4/view/a/af;->a(Landroid/view/View;I)V
...
.method private c(IILandroid/os/Bundle;)Z
    ...
    :sswitch_0
    invoke-direct {p0, p1, p2, p3}, Landroid/support/v4/widget/s;->d(IILandroid/os/Bundle;)Z
...
.method private d()Landroid/support/v4/view/a/o;
    ...
    invoke-static {v0, v1}, Landroid/support/v4/view/bu;->a(Landroid/view/View;Landroid/support/v4/view/a/o;)V
    ...
    iget-object v3, p0, Landroid/support/v4/widget/s;->i:Landroid/view/View;
...
.method private d(I)Landroid/support/v4/view/a/o;
    ...
    invoke-direct {p0, p1}, Landroid/support/v4/widget/s;->e(I)Landroid/support/v4/view/a/o;
    ...
    :pswitch_0
    invoke-direct {p0}, Landroid/support/v4/widget/s;->d()Landroid/support/v4/view/a/o;
...
.method private d(IILandroid/os/Bundle;)Z
    ...
    :sswitch_0
    invoke-direct {p0, p1}, Landroid/support/v4/widget/s;->g(I)Z
...
.method private e(I)Landroid/support/v4/view/a/o;
    ...
    invoke-virtual {p0, p1, v0}, Landroid/support/v4/widget/s;->a(ILandroid/support/v4/view/a/o;)V
    ...
    :cond_0
    iget-object v1, p0, Landroid/support/v4/widget/s;->e:Landroid/graphics/Rect;
    ...
    invoke-direct {p0, v1}, Landroid/support/v4/widget/s;->a(Landroid/graphics/Rect;)Z
    ...
    iget-object v2, p0, Landroid/support/v4/widget/s;->g:[I

    invoke-virtual {v1, v2}, Landroid/view/View;->getLocationOnScreen([I)V

    iget-object v1, p0, Landroid/support/v4/widget/s;->g:[I
    ...
    iget-object v3, p0, Landroid/support/v4/widget/s;->d:Landroid/graphics/Rect;

    iget-object v4, p0, Landroid/support/v4/widget/s;->e:Landroid/graphics/Rect;
    ...
    iget-object v1, p0, Landroid/support/v4/widget/s;->d:Landroid/graphics/Rect;
...
.method private g(I)Z
    ...
    :cond_1
    invoke-direct {p0, p1}, Landroid/support/v4/widget/s;->f(I)Z
...
.method public a(Landroid/view/View;)Landroid/support/v4/view/a/x;
    ...
    iget-object v0, p0, Landroid/support/v4/widget/s;->j:Landroid/support/v4/widget/u;
    ...
    invoke-direct {v0, p0, v1}, Landroid/support/v4/widget/u;-><init>(Landroid/support/v4/widget/s;Landroid/support/v4/widget/t;)V

    iput-object v0, p0, Landroid/support/v4/widget/s;->j:Landroid/support/v4/widget/u;
...
.method public a(II)Z
    ...
    invoke-static {v1, v2, v0}, Landroid/support/v4/view/dj;->a(Landroid/view/ViewParent;Landroid/view/View;Landroid/view/accessibility/AccessibilityEvent;)Z
